...
<?php
		if(isset($_POST["save"])) {
			...
			$sql = "insert into user (user_fullname, user_address, username, password, email, tel, user_type, car_regis_no, status)
				value ('$user_fullname', '$user_address', '$username', '$password', '$email', '$tel', '$user_type', '$car_regis_no', '$status');
				";
			//echo $sql;
...
?>
		...
		<input type="hidden" name="status" value="0">
            ...
            <p>
				...
				<input type="text" name="car_regis_no" class="form-control">
			</p>
            <p>
